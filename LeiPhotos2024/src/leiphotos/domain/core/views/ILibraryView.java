...
public interface ILibraryView {
    ...
    /**
     * Retorna uma lista de fotos na vista, ordenadas de acordo com o critério de ordenação corrente.
     * 
    ...
    /**
     * Retorna uma lista de fotos na vista que correspondem à expressão regular dada,
     * ordenadas de acordo com o critério de ordenação corrente.
     * 
